...
theme.set_highlights = function()
    ...
    hl(0, "CursorLineNr", { fg = "#FE9F3A", bg = 'NONE' }) -- c.light_gray
    ...
    hl(0, "CursorLine", { fg = 'NONE', bg = "NONE" }) -- c.alt_bg
    ...
    -- Code
    hl(0, "Comment", { fg = "#727169", bg = 'NONE' }) -- c.context
    hl(0, "Variable", { fg = "#ffffff", bg = 'NONE' }) -- c.light_blue
    hl(0, "String", { fg = c.green, bg = 'NONE' }) -- c.orange
    ...
    hl(0, "Constant", { fg = "#F39961", bg = 'NONE' }) --  c.vivid_blue
    hl(0, "Type", { fg = "#F9E2AF", bg = 'NONE' }) -- c.cyan
    hl(0, "Function", { fg = "#EABBB9", bg = 'NONE' }) -- c.yellow 
    hl(0, "Keyword", { fg = c.purple, bg = 'NONE' }) -- c.blue
    hl(0, "Conditional", { fg = c.purple, bg = 'NONE' })
    hl(0, "Repeat", { fg = c.purple, bg = 'NONE' })
    hl(0, "Operator", { fg = "#908CAA", bg = 'NONE' }) -- c.fg
    ...
    hl(0, "SpecialComment", { fg = "#727169", bg = 'NONE' }) -- c.fg
    ...
    -- Treesitter
    hl(0, "@comment", { fg = "#727169", bg = 'NONE', italic = true, }) -- c.green
    ...
    hl(0, "@parameter", { fg = "#EBA0AC", bg = 'NONE' }) -- c.light_blue
