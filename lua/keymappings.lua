...
vim.keymap.set("n", "<leader>bn", ":write<cr>:bprev<cr>", { desc = " Buffer: Next Tab and Write Buffer" })
vim.keymap.set("n", "<S-TAB>", ":write<cr>:bnext<cr>", { desc = " Buffer: Previous Tab and Write Buffer" })
vim.keymap.set("n", "<leader>bp", ":write<cr>:bnext<cr>", { desc = " Buffer: Previous Tab and Write Buffer" })
...
vim.keymap.set("n", "<leader>bv", ":vsplit<cr>", { desc = " Buffer: Vertical Split" })
vim.keymap.set("n", "<leader>bh", ":split<cr>", { desc = " Buffer: Horizontal Split" })
vim.keymap.set("n", "<leader>bq", ":bdelete!<cr>", { desc = " Buffer: Quit Buffer" })
...
vim.keymap.set("n", "<leader>ba", "GVgg", { desc = " Line: mark everything" })
