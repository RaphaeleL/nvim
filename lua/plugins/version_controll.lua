return {
    ...
    },
    {
        ...
        lazy = true,
        keys = {
            { "<Leader>ga", ":Git add .<cr><cr>", desc = " [G]it add ." },
            { "<Leader>gc", ":Git commit<cr><cr>", desc = " [G]it commit" },
            { "<Leader>gp", ":Git push<cr><cr>", desc = " [G]it push" },
            { "<Leader>gP", ":Git pull --rebase<cr><cr>", desc = " [G]it pull --rebase" },
            { "<Leader>gd", ":Git diff<cr><cr>", desc = " [G]it diff" },
        }
    },
    {
