...
vim.api.nvim_set_keymap("n", "mj", "<cmd>lua require('multicursor-nvim').lineAddCursor(1)<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("x", "mj", "<cmd>lua require('multicursor-nvim').lineAddCursor(1)<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "mk", "<cmd>lua require('multicursor-nvim').lineAddCursor(-1)<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("x", "mk", "<cmd>lua require('multicursor-nvim').lineAddCursor(-1)<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "mc", "<cmd>lua require('multicursor-nvim').clearCursors()<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("x", "mc", "<cmd>lua require('multicursor-nvim').clearCursors()<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "mm", "<cmd>lua require('multicursor-nvim').matchCursors()<cr>",
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("x", "mm", "<cmd>lua require('multicursor-nvim').matchCursors()<cr>",
    { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("n", "<leader><space>", ":Telescope find_files theme=ivy<cr>",
