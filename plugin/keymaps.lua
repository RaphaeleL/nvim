...
vim.keymap.set("n", "<leader>h", "<C-w>h", { desc = "Buffer: Move to the left Window" })
vim.keymap.set("n", "<leader>j", "<C-w>j", { desc = "Buffer: Move to the bottom Window" })
vim.keymap.set("n", "<leader>k", "<C-w>k", { desc = "Buffer: Move to the upper Window" })
vim.keymap.set("n", "<leader>l", "<C-w>l", { desc = "Buffer: Move to the right Window" })
